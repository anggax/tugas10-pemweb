		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					...
					<button type="submit" class="btn btn-primary" style="background-color: #36a33d; border-style: none;">
						<a href="daftarsiswa.php" style="text-decoration: none; color: white;">SIMPAN EXCEL</a>
					</button>
